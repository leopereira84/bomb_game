...
export default function Start() {
  ...
  return (
    <Container>
      ...
      */}
      <ButtonComponent buttonText={"Bora Jogar?"} handlePress={handleNavToPlayTogether} />
      <Rules onPress={handleNavToRules} style={{ marginTop: 200 }} >Ver as regras do jogo</Rules>
    </Container>
  );
}
